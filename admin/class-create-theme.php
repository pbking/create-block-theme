...
require_once( __DIR__ . '/create-theme/theme-variations.php' );
...
class Create_Block_Theme_Admin {
	...
	public function __construct() {
		...
		add_action( 'rest_api_init', array( 'Theme_Edit', 'register_endpoints' ) );
		add_action( 'rest_api_init', array( 'Theme_Variations', 'register_endpoints' ) );
	}
